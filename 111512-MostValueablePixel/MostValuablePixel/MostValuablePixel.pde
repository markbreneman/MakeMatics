...
//  println("pixelObjectArray Green" + pixelObjectArray.get(0).G);///GET THE RED VALUE OF PIXEL OBJECT1
//  println("pixelObjectArray Blue" + pixelObjectArray.get(0).B);///GET THE RED VALUE OF PIXEL OBJECT1
