...
void setup() {  
  ...
  redImg = loadImage("IMG_0023-900.png");
  blueImg = loadImage("IMG_0023-900.png");
  greenImg = loadImage("IMG_0023-900.png");
  
  hueImg = loadImage("IMG_0023-900.png");  
  saturationImg = loadImage("IMG_0023-900.png");
  brightnessImg = loadImage("IMG_0023-900.png");
